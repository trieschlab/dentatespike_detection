...
def detect_dentate_spikes(
    ...
    polarity : signed int, 1 or -1, wether ds are positive or negative deflections,
...
#    evts = rd.core.threshold_by_zscore(data, time, min_duration, zscore_thres)
    ...
    if return_trace:
        ...
        ts_trace_both = np.sort(np.concatenate((ts_trace_start, ts_trace_stop)))
